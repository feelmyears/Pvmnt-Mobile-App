...
@property(strong, nonatomic) IBOutletCollection(NSObject) NSArray* pvmntLoadingImageTargets;
@property(strong, nonatomic) IBOutletCollection(NSObject) NSArray* calendarIconTargets;
@property(strong, nonatomic) IBOutletCollection(NSObject) NSArray* sidewalkIconTargets;
